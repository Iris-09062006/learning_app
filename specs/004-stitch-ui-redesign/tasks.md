...
- [ ] **T016** [C3] Markdown renderer visual treatment (`src/features/lessons/components/lesson-markdown.tsx`)
...
- [ ] **T017** [C4] Code / list / blockquote / callout treatment
...
- [ ] **T018** [C5] Lesson progress / status / action / navigation controls
...
- [ ] **T019** [C6] Responsive + dark treatment (Lesson page)
...
- [ ] **T020** [C7] Browser screenshot comparison vs `lesson-render.png` (10-point checklist)
...
- [ ] **T021** [C8] UI UX Pro Max accessibility/usability review (Lesson page)
...
- [ ] **T022** [C9] Functional Lesson regression + Phase C gates
